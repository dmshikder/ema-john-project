/**
 * 1. create a new firebase project in console.log.com 
 ...
 * 5. create login, signbup component, setup route
 ...
 * 11. Create required  component ==> check user exists also track user location
